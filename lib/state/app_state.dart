...
abstract class _AppState with Store {
  ...
  Future<bool> delete(Reminder reminder) async {
    ...
    try {
      ...
      await remindersService.deleteReminderWithId(reminder.id, userId: userId);
  ...
  Future<bool> deleteAccount() async {
    ...
    try {
      ...
      await remindersService.deleteAllDocuments(userId: userId);
  ...
  Future<bool> createReminder(String text) async {
    ...
    final firebaseReminderId = await remindersService.createReminder(
      userId: userId,
      text: text,
  ...
  Future<bool> _loadReminders() async {
    ...
    final reminders = await remindersService.loadReminders(userId: userId);
